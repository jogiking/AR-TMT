...
namespace UnityEngine.XR.ARFoundation
{
    ...
    public class ARPointCloudParticleVisualizer2 : MonoBehaviour
    {
        public GameObject t;
        ...
        void SetVisible(bool visible)
        {
            ...
            t.GetComponent<Text>().text = "Point Cloud 갯수 : " +m_NumParticles.ToString();

            //  t.text = m_NumParticles.ToString();

            GameObject.Find("GameController").GetComponent<GameController>().updateNumOfParticles(m_NumParticles);
            //GameController.updateNumOfParticles(m_NumParticles);
